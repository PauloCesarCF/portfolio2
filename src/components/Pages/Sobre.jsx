...
const Sobre = () => {
  return(
    <main className={styles.main}>
      ...
      <p>Meu primeiro contato com programação foi em 2021 e de lá pra cá eu vi o que poderia ser feito com programação e eu acabei me apaixonando por tecnologia, agora em 2022 o meu objetivo é consegui minha primeira vaga como developer front-end e quero evoluir cada vez mais nessa área.</p>
      <div>
